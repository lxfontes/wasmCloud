...
use wasmcloud_host::solo::host_config::PolicyService as PolicyServiceConfig;
use wasmcloud_host::solo::Features;
use wasmcloud_host::url::Url;
use wasmcloud_host::{SoloHost, SoloHostConfig};
use wasmcloud_tracing::configure_observability;

#[derive(Debug, Parser)]
#[allow(clippy::struct_excessive_bools)]
#[clap(name = "wasmcloud-solo")]
...
struct Args {
    ...
    #[arg(
        ...
        value_delimiter = ',',
        hide = true,
        default_value = "builtin-http-server,rpc-interface"
    )]
